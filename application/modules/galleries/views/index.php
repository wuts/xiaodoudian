...
<? if ($galleries): ?>
    <ul class="photos-list-intro">
        <? foreach($photos as $photo): ?>
         ...
         <dl><dt class="float-left width-third"><?=mb_substr($photo->description,0,80,'UTF-8'); ?></dt><dt class="float-right width-third"><?=mb_substr($photo->description,80,70,'UTF-8'); ?><br /><?=anchor('galleries/photo/'.$photo->id,lang('gal_more_label'), array('style'=>'height:20px;'));?></dt></dl>
          </li>
        <? endforeach; ?>
     </ul>
<? else: ?>
