<div style="float:left;height:40px;padding-left:10px;">
 ...
 <div class="float-right" style="padding:0.5em;text-align:right">
     <table>
     <tr><td><?=image("icons/contact.gif","_theme_");?></td><td><a href="https://spreadsheets.google.com/viewform?formkey=dGdQUmZMZ1p6VzJ2VGxJWURnV05FcHc6MA"><span>13601834122</span></a></td><td><?=image("icons/calendar.gif");?></td><td><span style="color:black;"><a href="http://spreadsheets.google.com/viewform?formkey=dGdQUmZMZ1p6VzJ2VGxJWURnV05FcHc6MA">免费试听</a></span> | </td>
         <td>
     ...
     <div style="position:absolute !important;top:40px;right:30px;z-index:1;"><a href="https://spreadsheets.google.com/viewform?formkey=dGdQUmZMZ1p6VzJ2VGxJWURnV05FcHc6MA"><?=image("adv/free-try.png","",array('style'=>'width:200px;border:0;'));?></a></div>
